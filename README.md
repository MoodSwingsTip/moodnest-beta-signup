...
<head>
  ...
  <title>MoodNest Beta Sign-Up</title>
  ...
  <style>
    ...
    header img {
      ...
      max-height: 200px;
      object-fit: cover;
      border-bottom: 2px solid #e0cce2;
    }
    h1 {
      color: #82085c;
      margin: 30px 0 10px;
...
<body>
  <header>
    <img src="moodnest-banner.png" alt="MoodNest banner with clouds and doves" />
  </header>
  ...
  <div class="container">
    ...
    <p class="description">
      ...
      We’re inviting a small group of early users to test MoodNest before its public launch.
      Please complete the form below to join the beta list!
    </p>

    <h2 style="color:#82085c;">✨ Let’s discover a safe space for our emotional balance, clarity, and growth!</h2>
    ...
    <p class="description">
      💌 Ready to join us? Fill out the form below to reserve your early access spot.
    </p>

    <iframe class="form" src="https://docs.google.com/forms/d/e/1FAIpQLSd21v9kPtcC1mzWdyEmdFoa4-q1s86F2UVAbpFukENrXkAfvA/viewform?embedded=true">Loading…</iframe>
